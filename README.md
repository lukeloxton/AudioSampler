...
A lightweight macOS menu bar app for recording system audio. Capture audio from any app or all system audio at once, saved as WAV files. No ads, no subscriptions, no telemetry.
